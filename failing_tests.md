...
- **zrc-007a** until **zrc-007f**: creating/updating/partially updating `Zaak` with `communicatiekanaal`-url that does not point to a `communicatiekanaal`-resource throws a 500 instead of 400
